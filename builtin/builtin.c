...
void ucg_builtin_init_algo(struct ucg_builtin_algorithm *algo)
{
                                 ...
                                 unsigned phase_ep_index)
{
    ...
    if (ucs_unlikely(ucg_ep.am_ep == NULL)) {
        ...
        phase->send_thresh.max_short_one = UCS_MEMUNITS_INF;
        return UCS_OK;
    }

    phase->ep_attr = ucg_ep.am_ep_attr;
    phase->md      = ucg_ep.md;
                                       ...
                                       ucg_planner_ctx_h *planner_ctx_p)
{
    ...
    ucg_builtin_mpi_reduce_cb    = group->context->params.mpi_reduce_f;
    ucg_builtin_op_is_commute_cb = group->context->params.op_is_commute_f;
